    ...
    return (
        <div className="w-full py-10 font-roboto border-solid border-l-0 border-r-0 border-b-0 border-t-2 border-[#D9D9D9]">
            <div className="text-lg flex gap-2 pl-16 pb-10 md:text-[15px]">
                ...
                <span>{">"}</span>
                <span className="text-[#0092D1]">Mono Jack Connector</span>
            </div>
            <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
                <div className="product-image">
                    <img src={MJ} className="w-72 lg:w-64 md:w-52 md:pr-4 md:ml-2" alt="speaker-cable"/>
                </div>
                <div className="flex flex-col w-96 lg:w-4/6 product-image">
                    ...
                    <div className="text-smi font-normal tracking-wide leading-6 md:px-8 md:text-[11px]">
                        <span className="text-[#424242]">
                            Introducing our Mono Jack connector – the reliable choice for
                            mono audio connections. Designed for durability and optimal
                            signal transfer, this connector delivers consistent performance
                            in any application. Compact and sturdy, it's ideal for guitars,
                            amplifiers, and more. Enhance your audio experience with our
                            Mono Jack connector today.
                        </span>
                    </div>
                </div>
