...
const FormatScreen = () => {
    ...
    return (
        ...
        <div className="text-lg flex gap-2 pl-16 pb-10 md:pb-5 md:text-[12px] md:pl-6">
            ...
            <span>{">"}</span>
            <span className="text-[#0092D1]">21:9 Format Screen</span>
      </div>
        <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
            <div className="product-image">
                <img src={SMALL_SCREEN} className="w-72 lg:w-64 md:w-52 md:pr-4 md:mr-3 lg:mr-7" alt="speaker-cable"/>
            </div>
            <div className="flex flex-col w-96 lg:w-4/6 product-image">
                <div className="flex flex-col text-[32px] md:text-[18px] font-bold pb-6 md:gap-1 md:pl-16 md:flex-row lg:gap-2 lg:flex-row lg:pl-5">
                    <div className="flex gap-3">
                        <span>21:9 Format</span>
                    </div>
                ...
                <div className="text-smi font-normal tracking-wide leading-6 md:px-7 md:pl-11 md:text-[11px]">
                    <span className="text-[#424242]">
                        Immerse yourself in widescreen entertainment with our 21:9
                        Projector Screen: Designed for cinema enthusiasts and avid
                        gamers, this ultra-wide screen delivers a panoramic viewing
                        experience like no other. With its aspect ratio optimized for
                        cinematic content, every scene comes to life with stunning
                        detail and clarity. Whether you're watching the latest
                        blockbuster or indulging in your favorite video games, this
                        screen provides an unparalleled visual feast.
                    </span>
                </div>
            </div>
            <div className="flex flex-col gap-5 product-image md:gap-3 md:pr-3 lg:mb-7 lg:gap-7">
                    <div>
                    ...
                    <div className="flex gap-5 md:gap-6 lg:gap-10">
                        <Link to={"/portable-screen"} className="no-underline">
                        <ProductImageWithHover imageUrl={PORTABLE_SCREEN} productName={"Portable Screen"} />
                        </Link>
                        <Link to={"/manual-screen"} className="no-underline">
                        <ProductImageWithHover imageUrl={MANUAL_SCREEN} productName={"Manual Screen"} />
                        </Link>
