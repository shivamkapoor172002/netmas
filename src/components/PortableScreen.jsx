...
const PortableScreen = () => {
    ...
    return (
        ...
        <div className="text-lg flex gap-2 pl-16 pb-10 md:pb-5 md:text-[12px] md:pl-6">
            ...
            <span>{">"}</span>
            <span className="text-[#0092D1]">Portable Projector Screen</span>
      </div>
        <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
            <div className="product-image">
                <img src={PORTABLE_SCREEN} className="w-72 lg:w-64 md:w-52 md:pr-4 md:mr-3 lg:mr-5" alt="speaker-cable"/>
            </div>
            <div className="flex flex-col w-96 lg:w-4/6 product-image">
                ...
                <div className="text-smi font-normal tracking-wide leading-6 md:px-7 md:pl-11 md:text-[11px]">
                    <span className="text-[#424242]">
                        Take your presentations anywhere with our Portable Projector
                        Screen: Designed for those who need flexibility without
                        sacrificing performance. This lightweight screen sets up
                        quickly, providing a crisp and clear surface for your
                        projections. Whether you're conducting a business meeting or
                        hosting a backyard movie night, its compact design makes
                        transportation hassle-free, ensuring you're always ready to
                        impress.
                    </span>
                </div>
            </div>
