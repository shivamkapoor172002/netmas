    ...
    return (
        <div className="w-full py-10 font-roboto border-solid border-l-0 border-r-0 border-b-0 border-t-2 border-[#D9D9D9]">
            <div className="text-lg flex gap-2 pl-16 pb-10 md:text-[15px]">
                ...
                <span>{">"}</span>
                <span className="text-[#0092D1]">DMX Cable</span>
            </div>
            <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
                <div className="product-image">
                    <img src={DMX} className="w-72 lg:w-64 md:w-52 md:pr-3 md:mr-4 lg:mr-16" alt="speaker-cable" />
                </div>
                <div className="flex flex-col w-96 lg:w-4/6 product-image">
                    ...
                    <div className="text-smi font-normal tracking-wide leading-6 md:px-6 md:text-[11px]">
                        <span className="text-[#424242]">
                            Introducing our DMX cable, the essential link for professional
                            lighting setups. Engineered for seamless control and
                            reliability, this cable ensures precise communication between
                            your DMX-enabled lighting fixtures, controllers, and consoles.
                            Crafted with meticulous attention to detail, our DMX cable
                            features high-quality connectors and shielding to minimize
                            signal interference and deliver consistent performance in any
            ...
            <div className="flex justify-end mb-[-58.2px] md:mb-[-57.5px] mt-9 product-image bg-[#D9D9D9]">
