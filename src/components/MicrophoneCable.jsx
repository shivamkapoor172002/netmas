    ...
    return (
        <div className="w-full py-10 font-roboto border-solid border-l-0 border-r-0 border-b-0 border-t-2 border-[#D9D9D9]">
            <div className="text-lg flex gap-2 pl-16 pb-10 md:text-[15px]">
                ...
                <span>{">"}</span>
                <span className="text-[#0092D1]">Microphone Cable</span>
            </div>
            <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
                <div className="product-image">
                    <img src={MICROPHONE} className="w-72 lg:w-64 md:w-52 md:pr-3 md:mr-4 lg:mr-8" alt="speaker-cable" />
                </div>
                <div className="flex flex-col w-96 lg:w-4/6 product-image">
                    <div className="flex flex-col text-[32px] md:text-[22px] font-bold pb-6 md:gap-2 md:pl-20 md:flex-row lg:gap-2 lg:flex-row lg:pl-24">
                        <span>Microphone</span>
                        <span>Cable</span>
                    </div>
                    <div className="text-smi font-normal tracking-wide leading-5 md:px-6 md:pl-9 md:text-[11px]">
                        <span className="text-[#424242]">
                            Introducing our top-notch microphone cable, meticulously engineered
                            for premium audio performance. With its durable construction and
                            superior shielding, this cable ensures clear and reliable sound
                            transmission in any environment. Compatible with a variety of
                            microphones and audio gear, it's the perfect choice for musicians,
                            broadcasters, and content creators seeking professional-grade quality.
                            Elevate your audio experience with our microphone cable today.
                        </span>
                    </div>
                    <div className="flex flex-col pt-7 gap-3 w-full">
                        <div>
                            <span className="text-smi md:px-7">Variants:</span>
                        </div>
                        <div className="flex gap-4 md:px-8 md:gap-4 lg:gap-8">
                            <button className="bg-[#0092D1] text-stone-100 border-none px-4 py-2.5 md:px-3 rounded-md text-[12px] md:text-[10px] cursor-pointer">16 AWG</button>
                            <button className="bg-[#0092D1] text-stone-100 border-none px-4 py-2.5 md:px-3 rounded-md text-[12px] md:text-[10px] cursor-pointer">18 AWG</button>
                            <button className="bg-[#0092D1] text-stone-100 border-none px-4 py-2.5 md:px-3 rounded-md text-[12px] md:text-[10px] cursor-pointer">20 AWG</button>
                        </div>
            ...
            <div className="flex justify-end mb-[-58.2px] md:mb-[-57.4px] mt-9 product-image bg-[#D9D9D9]">
...
export default MicrophoneCable;