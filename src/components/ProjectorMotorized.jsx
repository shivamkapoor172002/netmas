...
const ProjectorMotorized = () => {
    ...
    return (
        ...
        <div className="text-lg flex gap-2 pl-16 pb-10 md:pb-5 md:text-[12px] md:pl-6">
            ...
            <span>{">"}</span>
            <span className="text-[#0092D1]">Projector Screen (Motorized)</span>
      </div>
        <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
            <div className="product-image">
                <img src={MOTORISED_SCREEN} className="w-72 lg:w-64 md:w-52 md:pr-4 md:mr-3 lg:mr-8" alt="speaker-cable"/>
            </div>
            <div className="flex flex-col w-96 lg:w-4/6 product-image">
                <div className="flex flex-col text-[32px] md:text-[18px] font-bold pb-6 md:gap-2 md:pl-16 md:flex-row lg:gap-2 lg:flex-row lg:pl-5">
                ...
                <div className="text-smi font-normal tracking-wide leading-6 md:px-7 md:pl-11 md:text-[11px]">
                    <span className="text-[#424242]">
                        Experience seamless entertainment and presentations with our
                        Motorized Projector Screen. Effortlessly transform any space
                        with the touch of a button, enjoying silent operation and
                        stunning image clarity. Compatible with a variety of
                        projectors, this screen brings immersive viewing to movies,
                        gaming, and professional meetings alike. Elevate your space
                        with convenience and elegance today.
                    </span>
                </div>
            </div>
...
export default ProjectorMotorized;