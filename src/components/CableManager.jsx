...
const CableManager = () => {
    ...
    return (
        ...
        <div className="text-lg flex gap-2 pl-16 pb-10 md:text-[15px] md:pl-8">
            ...
            <span>{">"}</span>
            <span className="text-[#0092D1]">Cable Manager</span>
        </div>
        <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
            <div className="product-image">
                <img src={CABLE_MANAGER} className="w-72 lg:w-64 md:w-52 md:pr-3 md:mr-3" alt="speaker-cable"/>
            </div>
            <div className="flex flex-col w-96 lg:w-4/6 product-image">
                <div className="flex gap-2 text-[32px] md:text-[22px] font-bold pb-6 md:gap-2 md:pl-28 md:flex-row lg:gap-2 lg:flex-row lg:pl-32">
                    <span>Cable</span>
                    <span>Manager</span>
                </div>
                <div className="text-smi font-normal tracking-wide leading-6 md:px-8 md:text-[11px]">
                    <span className="text-[#424242]">
                        Introducing our Cable Manager, the essential tool for
                        maintaining a tidy and organized workspace or entertainment
                        area. Say farewell to tangled cords and cluttered surfaces
                        with this sleek and efficient solution. Designed for easy
                        installation and versatile usage, our Cable Manager keeps
                        cables neatly organized and out of sight, providing a clean
                        and streamlined look to any setup. Say hello to a more
                        efficient and aesthetically pleasing environment with our
                        Cable Manager.
                    </span>
                </div>
            </div>
            <div className="flex flex-col gap-5 product-image md:gap-3 md:pr-3 lg:mb-10 lg:gap-7">
                    <div>
        ...
        <div className="flex justify-end mb-[-64px] md:mb-[-63.8px] mt-9 product-image bg-[#D9D9D9]">
