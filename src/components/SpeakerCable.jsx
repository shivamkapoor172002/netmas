    ...
    return (
        <div className="w-full py-10 font-roboto border-solid border-l-0 border-r-0 border-b-0 border-t-2 border-[#D9D9D9]">
            <div className="text-lg flex gap-2 pl-16 pb-10 md:text-[15px]">
                ...
                <span>{">"}</span>
                <span className="text-[#0092D1]">Speaker Cable</span>
            </div>
            <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
                <div className="product-image">
                    <img src={SPEAKER} className="w-72 lg:w-64 md:w-52 md:pr-4 md:mr-4 lg:mr-10" alt="speaker-cable" />
                </div>
                <div className="flex flex-col w-96 lg:w-4/6 product-image">
                    <div className="flex flex-col text-[32px] md:text-[22px] font-bold pb-6 md:gap-2 md:pl-24 md:flex-row lg:gap-2 lg:flex-row lg:pl-28">
                        <span>Speaker</span>
                        <span>Cable</span>
                    </div>
                    <div className="text-smi font-normal tracking-wide leading-5 md:px-6 md:pl-9 md:text-[11px]">
                        <span className="text-[#424242]">
                            Introducing our premium speaker cable, engineered to elevate your
                            audio experience to new heights. Crafted with meticulous attention to
                            detail, our speaker cable delivers pristine sound quality, ensuring
                            every note and nuance is conveyed with precision and clarity. Designed
                            for audiophiles and music enthusiasts alike, our cable features
                            high-quality conductors that minimize signal loss and interference.
                        </span>
                    </div>
                    <div className="flex flex-col pt-7 gap-3 w-full">
                        ...
                        <div className="flex gap-4 md:px-8 md:gap-4 lg:gap-8">
                            <button className="bg-[#0092D1] text-stone-100 border-none px-4 py-2.5 md:px-3 rounded-md text-[12px] md:text-[10px] cursor-pointer">1.5 square mm</button>
                            <button className="bg-[#0092D1] text-stone-100 border-none px-4 py-2.5 md:px-3 rounded-md text-[12px] md:text-[10px] cursor-pointer">2.5 square mm</button>
                            <button className="bg-[#0092D1] text-stone-100 border-none px-4 py-2.5 md:px-3 rounded-md text-[12px] md:text-[10px] cursor-pointer">4 square mm</button>
                        </div>
