    ...
    return (
        <div className="w-full py-10 font-roboto border-solid border-l-0 border-r-0 border-b-0 border-t-2 border-[#D9D9D9]">
            <div className="text-lg flex gap-2 pl-16 pb-10 md:text-[15px]">
                ...
                <span>{">"}</span>
                <span className="text-[#0092D1]">SpeakOn Connector</span>
            </div>
            <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
                <div className="product-image">
                    <img src={SPKON} className="w-72 lg:w-64 md:w-52 md:pr-4 md:ml-4" alt="speaker-cable"/>
                </div>
                <div className="flex flex-col w-96 lg:w-4/6 product-image">
                    <div className="flex flex-col text-[32px] md:text-[22px] font-bold pb-6 md:gap-2 md:pl-24 md:flex-row lg:gap-2 lg:flex-row lg:pl-20">
                        <span>SpeakOn</span>
                        <span>Connector</span>
                    </div>
                    <div className="text-smi font-normal tracking-wide leading-6 md:px-7 md:text-[11px]">
                        <span className="text-[#424242]">
                            Introducing our speaker connector – the powerhouse solution for
                            professional audio setup. engineered for maximum reliability and
                            performance, this connector ensures seamless transmission of high-quality
                            audio signals. robust construction and secure locking mechanism make it
