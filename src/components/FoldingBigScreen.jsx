...
const FoldingBigScreen = () => {
    ...
    return (
        ...
        <div className="text-lg flex gap-2 pl-16 pb-10 md:pb-5 md:text-[12px] md:pl-6">
            ...
            <span>{">"}</span>
            <span className="text-[#0092D1]">Folding Projector Screen</span>
      </div>
        <div className="flex justify-center px-20 gap-28 md:flex-col md:items-center md:gap-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
            <div className="product-image">
                <img src={FOLDING_SCREEN} className="w-72 lg:w-64 md:w-52 md:pr-4 md:mr-3 lg:mr-5" alt="speaker-cable"/>
            </div>
            <div className="flex flex-col w-96 lg:w-4/6 product-image">
                ...
                <div className="text-smi font-normal tracking-wide leading-6 md:px-7 md:pl-11 md:text-[11px]">
                    <span className="text-[#424242]">
                        Introducing our Folding Projector Screen: Elevate your
                        presentations or movie nights with this convenient and
                        versatile screen. Crafted for portability and ease of use,
                        it effortlessly unfolds to reveal a smooth, wrinkle-free
                        surface that enhances your viewing experience. Perfect for
                        professionals on the go or movie enthusiasts seeking a
                        portable solution without compromising on quality.
                    </span>
                </div>
            </div>
            <div className="flex flex-col gap-5 product-image md:gap-3 md:pr-3 lg:mb-7 lg:gap-7">
                    ...
                    <div className="flex gap-5 md:gap-6 lg:gap-10">
                        ...
                        <Link to={"/format-screen"} className="no-underline">
                        <ProductImageWithHover imageUrl={SMALL_SCREEN} productName={"Format Screen"} />
                        </Link>
...
export default FoldingBigScreen;