...
const ConnectorEP = () => {
  ...
  return (
    <div className="w-full py-10 font-roboto border-solid border-l-0 border-r-0 border-b-0 border-t-2 border-[#D9D9D9]">
      <div className="text-lg flex gap-2 pl-16 pb-10 md:text-[15px] md:pl-6">
        ...
        <span>{">"}</span>
        <span className="text-[#0092D1]">EP Connector</span>
      </div>
      <div className="flex justify-center px-20 gap-28 product-parent md:flex-col md:items-center md:gap-10 md:px-10 lg:flex-col lg:items-center lg:px-5 lg:gap-10">
        <div className="product-image">
          <img src={EP} className="w-72 md:w-52 lg:w-64 md:pr-3 md:ml-3 lg:ml-4" alt="speaker-cable" />
        </div>
        <div className="flex flex-col w-96 lg:w-4/6 product-image">
          <div className="flex flex-col text-[32px] md:text-[22px] font-bold pb-6 md:flex-row lg:flex-row md:gap-2 lg:gap-2 md:pl-28 lg:pl-32">
            <span>EP</span>
            <span>Connector</span>
          </div>
          <div className="text-smi font-normal tracking-wide leading-6 md:px-6 md:text-[11px]">
            <span className="text-[#424242]">
              Designed for versatility and performance, our EP connectors offer
              seamless connectivity for a variety of electronic devices.
              Whether you're connecting headphones, smartphones, or other
              portable devices, our EP connectors deliver crystal-clear audio
              transmission and a snug fit for uninterrupted listening
              pleasure. Built with quality materials, they're your go-to
              solution for convenient and reliable connections on the go.
            </span>
          </div>
        </div>
        <div className="flex flex-col gap-5 product-image md:gap-3 md:pr-6 lg:mb-4 lg:gap-7">
          <div>
            <span className="text-sm md:text-[12px] lg:text-[16px] md:ml-[-9px] lg:ml-[-35px]">Other Product Images</span>
          </div>
          <div className="flex gap-5 md:gap-6 lg:gap-10">
            ...
            <Link to={"/xlr-connector"} className="no-underline">
              <ProductImageWithHover imageUrl={XLR} productName="XLR" />
            </Link>
      ...
      <div className="flex justify-end mb-[-58.2px] mt-9 product-image bg-[#D9D9D9]">
